...
<head>
    ...
    *, *::before, *::after { box-sizing: border-box; }
    ...
    /* ── BOUTONS AUTH — hors du <ul>, jamais affectés par li a ── */
    .nav-auth-actions {
        display: flex;
        align-items: center;
        gap: 0.5rem;
    ...
    @media (max-width: 1024px) {
        ...
        /* Boutons : taille naturelle, côte à côte — aucune règle li a ne les touche */
        .nav-auth-actions {
            margin-left: 0;
    ...
    main.page-auth { background: var(--bg); }
    main.page-default { padding: 3rem 0; }
