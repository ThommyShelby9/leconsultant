...
<ul class=" nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
    ...
    <li class="nav-item has-treeview
        {{request()->routeIs('admin.pack.*') ? ' menu-open' : ''}} ">
        ...
        <ul class="nav nav-treeview"
          style="{{request()->routeIs('admin.pack.*') ? '  display: block' : ' display: none'}}">

            <li class="nav-item">
                <a href="{{Route('admin.pack.list')}}"
                class="{{ request()->routeIs('admin.pack.list')  ? 'nav-link active' : 'nav-link'  }}">
            ...
            <!--li class="nav-item">
                <a href="{{Route('admin.pack.new')}}"
                class="{{ request()->routeIs('admin.pack.new')  ? 'nav-link active' : 'nav-link'  }}">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Publier</p>
                </a>
            </li-->
    ...
    <li class="nav-item">
        <a href="{{ Route('admin.colab.list') }}"
            class="{{ request()->routeIs('admin.colab.list')  ? 'nav-link active' : 'nav-link'  }}">
