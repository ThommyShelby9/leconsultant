...
<section id="offres" class="relative">
    <div class="container">
        ...
        <div class="flex flex-wrap lg:flex-row flex-col items-center mb-6">
            ...
            data-aos-anchor-placement="top-bottom" >
                <div class="px-5">
                    ...
                    <div class="flex flex-wrap lg:flex-row flex-col" data-aos="fade-up"
                    data-aos-anchor-placement="top-bottom">
                        ...
                        <div class="lg:w-1/4 w-full mt-8" data-aos="zoom-in-up">
                            ...
                            <a href="{{ route('voirFichier',$file)  }}">
                                <button
                                    class="inline-block lg:mt-0 mt-10 py-4 bg-consultant-blue text-white inline-block rounded-lg w-full">
                                    Télécharger
                                </button>
                             </a>
                        </div>
        ...
        <div class="flex flex-wrap lg:flex-row flex-col items-center mb-6">
            ...
            <p class="lg:text-4xl text-4xl font-bold mb-8" >Aucune offre n'a été trouvée</p>
        </div>
