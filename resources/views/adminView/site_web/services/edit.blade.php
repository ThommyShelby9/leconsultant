    ...
    <div class="col-lg-12">
        <div class="card card-navy">
            ...
            <div class="card-body" style="display: block;">
                <form action="{{ route('adminSite.services.edit.save') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="titre" value="{{ @old('titre' ,$service->titre) }}" id=""
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="contenu" id="" cols="30" rows="10"
                            class="textarea">{{ @old('contenu',$service->contenu) }}</textarea>
                        @error('contenu')
                        <span class="text-danger">{{$message }}</span>
                        @enderror
                    </div>
                    <div class="form-row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="statut" id="" class="form-control">
                                    ...
                                    @case(True)
                                    <option value="1" selected>Publier en meme temps</option>
                                    <option value="0">Ne pas Publier en meme temps</option>
                                    @break
                                    @case(False)
                                    <option value="1">Publier en meme temps</option>
                                    <option value="0" selected>Ne pas Publier en meme temps</option>
                                    @break
                                    @endswitch
                                </select>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <a href="{{ $service->image }}">Voir l'image mis en avant</a>
                                @else
                                Aucune image msi en avant
                                @endif
                            </div>
                        </div>
                    </div>
