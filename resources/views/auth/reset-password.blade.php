        ...
        <div class="bg-consultant-blue lg:py-24 py-12 lg:px-16 px-8">
            <div class="grid lg:grid-cols-2 grid-cols-1">
                ...
                <div class="lg:order-2 order-1">
                    ...
                    <form method="POST" action="{{ route('password.update') }}" class="flex flex-col justify-between lg:px-24 px-0">
                        @csrf
                        ...
                        @error('password')
                        <span class="w-full bg-consultant-rouge py-3 text-center text-white text-lg mb-3">Veillez revoir votre mot de passe</span>
                        @enderror

                        <input readonly id="email" type="email" class="inp-log"
                            name="email" value="{{ $request->email }}" autocomplete="email" autofocus placeholder="Email">


                        <input id="password" type="password" class="inp-log"
                            name="password"  autocomplete="current-password" placeholder="Mot de passe">

                            <input id="password-confirm" type="password" class="inp-log" placeholder="Confirmer le mot de passe *"
